#!/usr/bin/env bash
# Build the browser (`worker:`) build of the units VGI worker: units-wasm
...
#   - `rustup component add rust-src` for the nightly toolchain, and the
...
LIB="target/$TARGET/release/libunits_wasm.a"
